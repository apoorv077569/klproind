...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $modules = [
            ...
            'help_tickets' => [
                'actions' => [
                    'index'   => 'backend.help_tickets.index',
                    'show'    => 'backend.help_tickets.show',
                    'reply'   => 'backend.help_tickets.reply',
                    'status'  => 'backend.help_tickets.status',
                    'destroy' => 'backend.help_tickets.destroy',
                ],
                'roles' => [
                    RoleEnum::ADMIN => ['index', 'show', 'reply', 'status', 'destroy'],
                ],
            ],
            'wallet_bonuses' => [
                'actions' => [
