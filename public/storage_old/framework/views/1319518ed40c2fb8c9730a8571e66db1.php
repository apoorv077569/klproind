...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('title', __('static.service_package.service_packages')); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5><?php echo e(__('static.service_package.service_packages')); ?></h5>
                    <div class="btn-action">
                        ...
                        <button type="button" class="btn btn-outline-primary import-redirect-btn" data-url="<?php echo e(route('backend.import-export.index', 'service-packages')); ?>">
                            <?php echo e(__('static.import.import')); ?> <i class="ri-download-2-line"></i>
                        </button>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.service-package.create')): ?>
                            <div class="btn-popup mb-0">
                                <a href="<?php echo e(route('backend.service-package.create')); ?>"
                                    class="btn"><?php echo e(__('static.service_package.create')); ?></a>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <form id="exportForm" method="GET" action="<?php echo e(route('backend.service-package.data.export')); ?>">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klpro_new\resources\views/backend/service-package/index.blade.php ENDPATH**/ ?>