...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('title', __('static.additional_service.additional_services')); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5><?php echo e(__('static.additional_service.additional_services')); ?></h5>
                    <div class="btn-action">
                        ...
                        <button type="button" class="btn btn-outline-primary import-redirect-btn" data-url="<?php echo e(route('backend.import-export.index', 'additional-services')); ?>">
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.service.create')): ?>
                            <div class="btn-popup mb-0">
                                <a href="<?php echo e(route('backend.additional-service.create')); ?>"
                                    class="btn"><?php echo e(__('static.additional_service.create')); ?></a>
                            </div>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('backend.service.destroy')): ?>
                            <a href="javascript:void(0);" class="btn btn-sm btn-secondary deleteConfirmationBtn" style="display: none;"
                                data-url="<?php echo e(route('backend.delete.services')); ?>">
                ...
                <div class="modal-body">
                    <form id="additionalServiceFilterForm">
                        <div class="mb-3">
                            ...
                            <label class="col-md-2" for="user_id"><?php echo e(__('static.services')); ?></label>
    ...
    <form id="exportForm" method="GET" action="<?php echo e(route('backend.additional-service.data.export')); ?>">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\klpro_new\resources\views/backend/additional-service/index.blade.php ENDPATH**/ ?>