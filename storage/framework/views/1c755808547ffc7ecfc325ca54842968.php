...
<body>
        ...
        <div class="uk-offcanvas-bar">
            ...
            <nav class="uk-navbar-container">
                <ul class="uk-navbar-nav">
                    ...
                    <li><a href="<?php echo e(route('frontend.about.index')); ?>">About Us</a></li>
                    <li><a href="<?php echo e(route('frontend.home')); ?>#services">Our Services</a></li>
                    <li><a href="<?php echo e(route('frontend.home')); ?>#clients">Testimonials</a></li>
                    <li><a href="<?php echo e(route('frontend.contact.index')); ?>">Contact Us</a></li>
                </ul>
            </nav>
        </div>
    </div>
    ...
    <!-- End Navbar Area --><?php /**PATH C:\Users\Apoorv Rathore\Desktop\Full Stack Training\klpro_admin\resources\views/import/header.blade.php ENDPATH**/ ?>