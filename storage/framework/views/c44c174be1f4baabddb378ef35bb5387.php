<section class="uk-creative-contact creative-contact-area ptb-100">
    <div class="uk-container">
        <div class="uk-grid uk-grid-match uk-grid-medium uk-child-width-1-2@m uk-child-width-1-1@s">
            <div class="item">
                <div class="section-title-with-big-text top-zero text-left">
                ...
                <div class="creative-contact-image with-wrap-color">
                    ...
                    <div class="info-content">
                        <h3>Our Office</h3>
                        <span>Shop No.5, 5th Floor, East Avenue Grand Complex, Kohli Vihar, Noida, Sector-49, Distt. Gautam Buddha Nagar, U.P. - 201301</span>
                    </div>
                </div>
            </div>
                ...
                <form class="creative-contact-form">
                    <div class="uk-grid uk-grid-match uk-grid-medium uk-child-width-1-2@m uk-child-width-1-1@s">
                        <div class="item uk-margin">
                            ...
                            <input type="text" class="uk-input" placeholder="Enter Your Name ">
                        </div>

                        <div class="item uk-margin">
                            <label class="uk-form-label" for="form-stacked-text">Email</label>
                            <input type="email" class="uk-input" placeholder="Enter Your Mail">
                        </div>

                        <div class="item uk-margin">
                            <label class="uk-form-label" for="form-stacked-text">Phone</label>
                            <input type="number" class="uk-input" placeholder="Enter Your Number">
                        </div>
...
</section><?php /**PATH C:\Users\Apoorv Rathore\Desktop\Full Stack Training\klpro_admin\resources\views/import/contact_form.blade.php ENDPATH**/ ?>