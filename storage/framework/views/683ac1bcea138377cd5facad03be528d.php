...
<?php $__env->startSection('content'); ?>
            ...
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="btn-action">
                        ...
                        <button type="button" class="btn btn-outline-primary import-redirect-btn" data-url="<?php echo e(route('backend.import-export.index', 'serviceman')); ?>">
                ...
                <div class="modal-body">
                    <form id="servicemanFilterForm">
                        <div class="mb-3">
                            ...
                            <label class="col-md-2"><?php echo e(__('static.home_pages.providers')); ?></label>
    ...
    <form id="exportForm" method="GET" action="<?php echo e(route('backend.serviceman.export.data')); ?>">
...
<?php echo $__env->make('backend.layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Apoorv Rathore\Desktop\Full Stack Training\klpro_admin\resources\views/backend/serviceman/index.blade.php ENDPATH**/ ?>