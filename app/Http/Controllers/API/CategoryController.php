...
/*            if ($request->zone_ids) {
    ...
    public function categoryServices(Request $request)
    {
        try {
            ...
            $zone_ids = $request->zone_ids ? array_filter(explode(',', $request->zone_ids)) : [];
...
/*            if (!empty($zone_ids)) {
                $categories->whereHas('zones', function ($zones) use ($zone_ids) {
                    $zones->whereIn('zone_id', $zone_ids);
                });
            }*/
...
/*            if (!empty($zone_ids)) {
                $query->whereHas('zones', function ($zones) use ($zone_ids) {
                    $zones->whereIn('zone_id', $zone_ids);
                });
            }*/
