...
use App\Http\Requests\API\UpdateServicemanProfileRequest;
...
class AccountController extends Controller
{
    ...
    public function updateServicemanProfile(UpdateServicemanProfileRequest $request)
    {
        return $this->repository->updateServicemanProfile($request);
    }
