...
class ServicePackage extends Model implements HasMedia
{
    ...
    {
        return $this->belongsToMany(Zone::class, 'service_package_zones');
    }

    public function servicemen()
    {
        return $this->belongsToMany(User::class, 'service_package_servicemen', 'service_package_id', 'serviceman_id');
    }
}
