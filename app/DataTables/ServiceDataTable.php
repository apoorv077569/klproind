...
class ServiceDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->addColumn('zones', function ($row) {
                $zones = $row->zones->pluck('name')->toArray();
    ...
    public function query(Service $model): QueryBuilder
    {
        ...
        $services = $model->newQuery()->whereNull('parent_id')->with(['user', 'zones']);
        if(request()->zone){
            $zoneId = request()->zone;
            $services = $services->whereHas('zones', function ($query) use ($zoneId) {
        ...
        if ($zoneIds) {
            $services->whereHas('zones', function ($query) use ($zoneIds) {
    ...
    public function html(): HtmlBuilder
    {
        ...
        $builder
            ...
            ->addColumn(['data' => 'zones', 'title' => __('static.zone.zones') ?? 'Zones', 'orderable' => false, 'searchable' => false]);
