...
class ServicePackageDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('zones', function ($row) {
                return $row->zones->pluck('name')->implode(', ');
            })
    ...
    public function query(ServicePackage $model): QueryBuilder
    {
        ...
        // Removed provider filtering as per user request to remove provider system
    ...
    public function html(): HtmlBuilder
    {
        ...
        if ($user->can('backend.service-package.destroy')) {
            ...
            ->addColumn(['data' => 'zones', 'title' => __('static.zone.all'), 'orderable' => false, 'searchable' => false])
