...
Route::group(['middleware' => ['auth', 'route.access'], 'namespace' => 'Backend', 'as' => 'backend.'], function () {
    ...
    Route::resource('/serviceman-time-slot', 'ServicemanTimeSlotController', ['except' => ['show']]);
    Route::put('serviceman-time-slot/status/{id}', 'ServicemanTimeSlotController@status')->name('serviceman-time-slot.status');
    Route::delete('delete-serviceman-time-slots', 'ServicemanTimeSlotController@deleteRows')->name('delete.serviceman-time-slots');
    ...
    Route::get('get-provider-services', 'ServiceController@getProviderServices')->name('get-provider-services');
    ...
    Route::post('serviceman/get-zone-services', 'ServicemanController@getZoneServices')->name('serviceman.get-zone-services');
    ...
    Route::get('cart', 'CartController@index')->name('cart.index')->middleware('can:backend.booking.index');
    Route::get('cart/reminder/{id}', 'CartController@reminder')->name('cart.reminder')->middleware('can:backend.booking.index');
    ...
    Route::get('get-zone-services', 'ServicePackageController@getZoneServices')->name('get-zone-services');
    Route::get('get-zone-servicemen', 'ServicePackageController@getZoneServicemen')->name('get-zone-servicemen');
    ...
    Route::resource('help-tickets', 'HelpTicketController', ['except' => ['create', 'edit', 'store', 'update']]);
    Route::post('help-tickets/{id}/reply', 'HelpTicketController@reply')->name('help-tickets.reply');
    Route::put('help-tickets/{id}/status', 'HelpTicketController@updateStatus')->name('help-tickets.status');
});
