...
Route::group([], function () {
    ...
    // Registration OTP — Send & Verify (for both User and Provider)
    Route::post('/send-register-otp',   'App\Http\Controllers\API\AuthController@sendRegisterOtp');
    Route::post('/verify-register-otp', 'App\Http\Controllers\API\AuthController@verifyRegisterOtp');
    ...
    Route::get('providers-with-services', 'App\Http\Controllers\API\ProviderController@providersWithServices');
    ...
    // Servicemans
    Route::get('serviceman/dropdowns', 'App\Http\Controllers\API\ServicemanController@dropdowns');
    Route::post('serviceman/get-zone-services', 'App\Http\Controllers\API\ServicemanController@getZoneServices');
    Route::get('serviceman/open-requests', 'App\Http\Controllers\API\BookingController@openRequests')->middleware('auth:sanctum');
    Route::get('user-zone-servicemen', 'App\Http\Controllers\API\ServicemanController@servicemenInUserZone')->middleware('auth:sanctum');
    ...
    Route::get('check-service-availability', 'App\Http\Controllers\API\ServiceController@checkAvailability');
    ...
    Route::get('document/dropdown', 'App\Http\Controllers\API\DocumentController@dropdown');
    //Document
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::put('serviceman/update-profile', 'App\Http\Controllers\API\AccountController@updateServicemanProfile');
        ...
        // Serviceman Time Slots
        Route::get('serviceman-time-slot/{serviceman_id}', 'App\Http\Controllers\API\ServicemanController@servicemanTimeSlot');
        Route::post('serviceman-time-slot', 'App\Http\Controllers\API\ServicemanController@storeServicemanTimeSlot');
        Route::put('update-serviceman-time-slot', 'App\Http\Controllers\API\ServicemanController@updateServicemanTimeSlot');
        Route::patch('serviceman-time-slot/{timeslotId}/status', 'App\Http\Controllers\API\ServicemanController@updateServicemanTimeSlotStatus');
        ...
        Route::post('booking/{id}/accept', 'App\Http\Controllers\API\BookingController@acceptBooking');
        Route::match(['get', 'post'], 'isValidTimeSlot', 'App\Http\Controllers\API\ProviderController@isValidTimeSlot');
        ...
        Route::post('booking/verify-otp', 'App\Http\Controllers\API\BookingController@verifyOtp');
        ...
        Route::post('cart', 'App\Http\Controllers\API\CartController@store');
        Route::post('cart/{id}', 'App\Http\Controllers\API\CartController@update');
        Route::delete('cart/{id}', 'App\Http\Controllers\API\CartController@destroy');
        Route::delete('cart/empty', 'App\Http\Controllers\API\CartController@emptyCart');
        ...
        Route::post('/upload-serviceman-document', 'App\Http\Controllers\API\DocumentController@uploadServicemanDocument');
        ...
        Route::get('help-tickets', 'App\Http\Controllers\API\HelpTicketController@index');
        Route::post('help-tickets', 'App\Http\Controllers\API\HelpTicketController@store');
        Route::get('help-tickets/{id}', 'App\Http\Controllers\API\HelpTicketController@show');
        Route::post('help-tickets/{id}/reply', 'App\Http\Controllers\API\HelpTicketController@reply');
    });
});
