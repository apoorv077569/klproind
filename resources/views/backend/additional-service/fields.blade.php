    ...
    <div class="col-md-10">
        <div class="input-group mb-3 flex-nowrap">
            ...
            <input class="form-control" 
                   ...
                   name="duration" 
                   min="1"
                   value="{{ isset($additionalService->duration) ? $additionalService->duration : old('duration') }}"
                   placeholder="Enter duration">

            <select class="form-select" name="duration_unit" style="max-width: 120px;">
                <option value="minutes"
                    {{ (isset($additionalService->duration_unit) && $additionalService->duration_unit == 'minutes') ? 'selected' : '' }}>
                    Min
                </option>
                <option value="hours"
                    {{ (isset($additionalService->duration_unit) && $additionalService->duration_unit == 'hours') ? 'selected' : '' }}>
                    Hours
                </option>
            </select>
