                                                    ...
                                                    <div class="service-details-box">
                                                        ...
                                                        @else
                                                            <div class="initial-letter">
                                                                {{ $serviceman ? strtoupper(substr($serviceman->name, 0, 1)) : '?' }}</div>
                                                        @endif
                                                        <div class="service-details">
                                                            <h5>{{ $serviceman?->name ?? 'No Serviceman' }}</h5>
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table top-providers-table">
                                    ...
                                    <tbody>
                                        @forelse ($topServicemen as $provider)
                                            <tr>
                                                <td>
                                                    <div class="service-details-box">
                                                        @php
                                                ...
                                                <td>{{ $provider?->servicemen_bookings_count }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="service-details-box">
                                                    ...
                                                    @else
                                                        <div class="initial-letter">
                                                            {{ $serviceman ? strtoupper(substr($serviceman->name, 0, 1)) : '?' }}
                                                        </div>
                                                    @endif
