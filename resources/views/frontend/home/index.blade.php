  ...
  <div class="uk-container">
    ...
    <p>
      ...
      <ul class="banner-btn-list">
        <li>
          <a href="{{route('frontend.contact.index')}}" class=" uk-button uk-button-default">Get Started</a>
        </li>
        <li>
          <a href="{{route('frontend.about.index')}}" class="uk-button uk-button-default">About Us</a>
        </li>
      </ul>
    </div>
  </div>
